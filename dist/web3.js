...
function getJsonRpcProvider(providerOrUrl) {
  var option = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'any';
  return new _ethers.ethers.providers.JsonRpcProvider(providerOrUrl, option);
}

function getWeb3Provider(providerOrUrl) {
  var option = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'any';
  return new _ethers.ethers.providers.Web3Provider(providerOrUrl, option);
}
...
function _setupWeb() {
  _setupWeb = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(_ref) {
    var customProvider, _ref$reloadOnAccounts, reloadOnAccountsChange, _ref$enforceReadOnly, enforceReadOnly, _ref$enforceReload, enforceReload, ensAddress, iframeProvider, id, url;
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 60:
            throw new Error('No web3 instance injected. Falling back to cloud provider.');
